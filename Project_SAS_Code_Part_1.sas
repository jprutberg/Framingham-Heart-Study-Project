...
/* Framingham Risk Score (FRS) Computation */
data FRM_Period3;
	set FRM;
	where period = 3;
run;
...
title "FRS Summary Statistics by Sex";
...
/* Create representative components of FRS */
proc sort data = FRM; by randid; run;

title "Create Representative Components of FRS";
...
title "FRS Representative Components Summary Statistics";
...
/* Regression of Pulse Pressure and FRS */
...
title "Regression of Pulse Pressure and FRS";
...
title "Simple Linear Regression Fit Metrics";
...
/* Regression of Pulse Pressure and FRS components */
...
title "Model Selection Using Mallows C(p)";
proc glmselect data = Q7;
	class sex;
	model pulse_pressure = age sex cigpday_avg bmi_avg heartrte_avg glucose_max totchol_max 
...
title "Model Selection Using Adjusted R-Squared";
proc glmselect data = Q7;
	class sex;
	model pulse_pressure = age sex cigpday_avg bmi_avg heartrte_avg glucose_max totchol_max 
